  ...
  return (
    <div style={{ minHeight: '100vh', background: '#050D1A', padding: '60px 24px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <h1 style={{ color: '#F0F6FF', fontFamily: 'serif', fontSize: '42px', marginTop: '32px' }}>Privacy Policy</h1>
        ...
        <p style={{ color: 'rgba(192,208,232,0.75)', fontSize: '14px', lineHeight: '1.8' }}>Essential cookies only: authentication session (Supabase) and dashboard preferences. No advertising or tracking cookies. Empire PM is ad-free.</p>
        ...
        <h2 style={{ color: '#E8B84B', fontSize: '20px', marginTop: '32px' }}>9. GDPR (EU/UK)</h2>
        <p style={{ color: 'rgba(192,208,232,0.75)', fontSize: '14px', lineHeight: '1.8' }}>Legal basis: contract performance and legitimate interests. You may lodge complaints with your local data protection authority.</p>
