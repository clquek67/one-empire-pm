  ...
  return (
    <div style={{ minHeight: '100vh', background: '#050D1A', padding: '60px 24px', fontFamily: 'sans-serif' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <h1 style={{ color: '#F0F6FF', fontFamily: 'serif', fontSize: '42px', marginTop: '32px' }}>Terms of Service</h1>
        ...
        <h2 style={{ color: '#E8B84B', fontSize: '20px', marginTop: '32px' }}>4. Subscription & Payment</h2>
