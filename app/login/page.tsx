    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: '11px', color: 'rgba(240,246,255,0.25)', lineHeight: '1.6' }}>
          By signing in you agree to our <a href="/terms" style={{ color: '#E8B84B', textDecoration: 'none' }}>Terms of Service</a> and <a href="/privacy" style={{ color: '#E8B84B', textDecoration: 'none' }}>Privacy Policy</a>.<br/>
